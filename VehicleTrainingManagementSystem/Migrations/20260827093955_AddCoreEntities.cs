        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trainers_Users_RegisteredByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PdfFilePath = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Certificates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Certificates_TrainingSessions_TrainingSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_TrainingSessionId",
                table: "Certificates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainers_RegisteredByUserId",
                table: "Trainers",
